...
define('UC_DBPW', '1'); // UCenter 数据库密码
define('UC_DBNAME', 'ucenter'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`ucenter`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', '68u4ZbhaB83a1crev1I052X6q8PaCajaI4h1T2t8jfN4c6s2p4a2P5Q7Z3ufn665'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://localhost:8888/ucenter'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
