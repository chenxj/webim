...
//Ucenter Home安全相关
$_SC['founder'] 		= '1,1256'; //创始人 UID, 可以支持多个创始人，之间使用 “,” 分隔。部分管理功能只有创始人才可操作。
...
define('UC_DBNAME', 'ucenter2'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`ucenter2`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'B027i470w547h2mfdau0E8W2Lba0A6wae61dP0J5J6c5uf54R6M4F9g2t90fK2o7'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://bbs.nextim.cn/ucenter'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
define('UC_CHARSET', 'utf-8'); // UCenter 的字符集
define('UC_IP', '211.144.86.221'); // UCenter 的 IP, 当 UC_CONNECT 为非 mysql 方式时, 并且当前应用服务器解析域名有问题时, 请设置此值
define('UC_APPID', '13'); // 当前应用的 ID
define('UC_PPP', 20);
