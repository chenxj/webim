<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_pm|template/default/header|template/default/footer|template/default/webim_uchome|template/default/webim_uchome|template/default/webim_uchome|template/default/webim_uchome|template/default/webim_uchome|template/default/webim_uchome|template/default/webim_uchome|template/default/webim_uchome|template/default/webim_uchome', '1268703202', 'template/default/cp_pm');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
