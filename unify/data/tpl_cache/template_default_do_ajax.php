<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/do_ajax|template/default/header|template/default/space_comment_li|template/default/space_post_li|template/default/space_share_li|template/default/footer|template/default/webim_uchome', '1268655075', 'template/default/do_ajax');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
