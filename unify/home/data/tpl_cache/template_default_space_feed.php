<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_feed|template/default/header|template/default/space_status|template/default/space_menu|template/default/space_feed_li|template/default/space_feed_li|template/default/space_feed_li|template/default/footer|template/default/webim', '1264687213', 'template/default/space_feed');?><?php if(empty($_TPL['getmore'])) { ?>	
...
<?php if($_IMC['enable']) { ?>
        ...
        <script src="webim/static/webim.all.min.js" type="text/javascript"></script>
        <script src="webim/static/i18n/webim-<?=$_IMC['local']?>.js" type="text/javascript"></script>
        <script src="webim/custom.js.php" type="text/javascript"></script>
        <?php } else { ?>
        <script type="text/javascript">
